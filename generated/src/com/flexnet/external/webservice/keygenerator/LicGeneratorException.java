...
public class LicGeneratorException
    extends Exception
{
     ...
     * @param message
     */
    public LicGeneratorException(String message, SvcException faultInfo) {
        super(message);
     ...
     * @param message
     */
    public LicGeneratorException(String message, SvcException faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
